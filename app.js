...
function newGame(){
  ...
  game.discardPile = [];
  game.deck = [
    {info: 1, color: 'red', quote:"Some people are worth melting for."},
    ...
    {info: 10, color: 'red', quote:"Some people are worth melting for."},
    {info: 11, color: 'red', quote:"Some people are worth melting for."},
    {info: 12, color: 'red', quote:"Some people are worth melting for."},
    {info: "Draw Two", color: 'red', quote:"Only an act of true love can thaw a frozen heart."},
    {info: 1, color: 'green', quote:"Hi, everyone. I'm Olaf and I like warm hugs!"},
    ...
    {info: 10, color: 'green', quote:"Some people are worth melting for."},
    {info: 11, color: 'green', quote:"Some people are worth melting for."},
    {info: 12, color: 'green', quote:"Some people are worth melting for."},
    {info: "Draw Two", color: 'green', quote:"Some people are worth melting for."},
    {info: 1, color: 'blue', quote:" Do you want to build a snowman?"},
    ...
    {info: 10, color: 'blue', quote:"Some people are worth melting for."},
    {info: 11, color: 'blue', quote:"Some people are worth melting for."},
    {info: 12, color: 'blue', quote:"Some people are worth melting for."},
    {info: "Draw Two", color: 'blue', quote:"Say it with us: Don't you dare!"},
    {info: 1, color: 'yellow', quote:"Some people are worth melting for."},
    ...
    {info: 10, color: 'yellow', quote:"Say it with us: Don't you dare!"},
    {info: 11, color: 'yellow', quote:"Say it with us: Don't you dare!"},
    {info: 12, color: 'yellow', quote:"Say it with us: Don't you dare!"},
